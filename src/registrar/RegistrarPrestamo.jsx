...
function RegistrarPrestamos() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-4">
      <h1 className="text-2xl font-bold mb-2 text-center">Registrar Producto</h1>
      {showCamera && (
        <>
          <h2 className="text-xl font-mono  mb-2 text-center">Toma una captura del producto</h2>
